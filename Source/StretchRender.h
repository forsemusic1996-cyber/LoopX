...
inline std::shared_ptr<MiniSamplerSample> renderBpmSample(const MiniSamplerSample& original,
                                                        ...
                                                        const std::function<bool()>& cancelled)
{
    ...
    auto result = std::make_shared<MiniSamplerSample>(); result->rate = original.rate; result->file = original.file;
